...
namespace org.apache.commons.math3.util
{
    ...
    public class Precision
    {
        ...
        /// <summary>
        /// Positive zero bits. </summary>
        private static readonly int POSITIVE_ZERO_FLOAT_BITS = MyUtils.FloatToRawIntBits(+0.0f);
        /// <summary>
        /// Negative zero bits. </summary>
        private static readonly int NEGATIVE_ZERO_FLOAT_BITS = MyUtils.FloatToRawIntBits(-0.0f);
...
//ORIGINAL LINE: final int xInt = MyUtils.FloatToRawIntBits(x);
            int xInt = MyUtils.FloatToRawIntBits(x);
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final int yInt = MyUtils.FloatToRawIntBits(y);
            int yInt = MyUtils.FloatToRawIntBits(y);
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final long xInt = MyUtils.DoubleToRawLongBits(x);
            long xInt = MyUtils.DoubleToRawLongBits(x);
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final long yInt = MyUtils.DoubleToRawLongBits(y);
            long yInt = MyUtils.DoubleToRawLongBits(y);
