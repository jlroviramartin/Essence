...
namespace org.apache.commons.math3.analysis.solvers
{
    ...
    public abstract class AbstractUnivariateSolver : BaseAbstractUnivariateSolver<UnivariateFunction>, UnivariateSolver
    {
        ...
        protected internal AbstractUnivariateSolver(double absoluteAccuracy)
        ...
        /// <param name="absoluteAccuracy"> Maximum absolute error. </param>
        protected internal AbstractUnivariateSolver(double relativeAccuracy, double absoluteAccuracy)
        ...
        protected internal AbstractUnivariateSolver(double relativeAccuracy, double absoluteAccuracy, double functionValueAccuracy)
