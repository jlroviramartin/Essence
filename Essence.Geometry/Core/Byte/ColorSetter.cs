...
namespace Essence.Geometry.Core.Byte
{
    public sealed class ColorSetter3b : IColorSetter3
    {
        ...
        {
            return new Color3b(this.r, this.g, this.b);
        }
        ...
        {
            this.r = ColorUtils.ToChannelByte(c1);
            this.g = ColorUtils.ToChannelByte(c2);
            this.b = ColorUtils.ToChannelByte(c3);
        }
    }
    ...
    public sealed class ColorSetter4b : IColorSetter4
    {
        ...
        {
            return new Color4b(this.r, this.g, this.b, this.a);
        }
        ...
        public void SetColor(float c1, float c2, float c3, float c4)
        {
            ...
            this.g = ColorUtils.ToChannelByte(c2);
            this.b = ColorUtils.ToChannelByte(c3);
            this.a = ColorUtils.ToChannelByte(c4);
        }
    }
}