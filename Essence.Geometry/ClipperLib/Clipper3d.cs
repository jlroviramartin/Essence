...
namespace ClipperLib
{
    ...
    {
        public Clipper3d(IClipperConverter3d converter)
        {
        ...
        public bool AddPath(IEnumerable<Point3d> poly, PolyType type, bool closed)
        {
        ...
        public bool AddPaths<TPoly>(IEnumerable<TPoly> polys, PolyType type, bool closed)
            where TPoly : IEnumerable<Point3d>
        {
        ...
        public bool Execute(ClipType clipType, List<List<Point3d>> solution,
        ...
        public void SimplifyPolygon(IEnumerable<Point3d> poly, List<Point3d> solution,
                                    PolyFillType fillType = PolyFillType.pftEvenOdd)
        {
        ...
        public void SimplifyPolygons<TPoly>(IEnumerable<TPoly> polys, List<List<Point3d>> solution,
                                            PolyFillType fillType = PolyFillType.pftEvenOdd)
            where TPoly : IEnumerable<Point3d>
        {
        ...
        private readonly IClipperConverter3d converter;
