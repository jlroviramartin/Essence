...
namespace Essence.Math
{
    ...
    public class Line
    {
        public Line(Vec2d p0, double t0, Vec2d p1, double t1, double normal, double radio)
        {
            this.p0 = p0;
            this.t0 = t0;
            this.p1 = p1;
        ...
        public double Evaluate(Vec2d pnt)
        {
        ...
        public void PuntoEje(double t, out Vec2d pnt, out double normal, out double radio)
        {
        ...
        public AABoundingBox2 GetEnvelope(double t0, double t1)
        {
            if (t0.EpsilonEquals(this.t0) && t1.EpsilonEquals(this.t1))
            {
                return new AABoundingBox2(this.p0, this.p1);
            }

            if (this.t0.EpsilonEquals(this.t1))
            {
                return new AABoundingBox2(this.p0, this.p0);
            }
            ...
            return new AABoundingBox2(
                this.Evaluate01(t01_0),
                this.Evaluate01(t01_1));
        }

        public AABoundingBox2 GetEnvelope(double d, double estacion1, double estacion2)
        {
            double t0 = this.t0;
            double t1 = this.t1;

            Vec2d v = vecMath.PerpRight(this.dirN).Mul(d);

            if (estacion1.EpsilonEquals(this.t0) && estacion2.EpsilonEquals(this.t1))
            {
                return new AABoundingBox2(this.p0.Add(v), this.p1.Add(v));
            }

            if (this.t0.EpsilonEquals(this.t1))
            {
                return new AABoundingBox2(this.p0.Add(v), this.p0.Add(v));
            }
