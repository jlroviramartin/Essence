...
namespace Essence.Math.Double
{
    public static partial class MathUtils
    {
        ...
        public static Vec2d Clotho(double s, bool invertY, double a)
        {
            double x, y;
        ...
        public static double ClothoRadious(double s, bool invertY, double a)
        {
            ...
            {
                radius = SafeSign(s) * double.PositiveInfinity; // Punto de inflexion, puede ser (+) o (-).
            }
            else
            {
                radius = (a * a / s);
        ...
        /// </summary>
        public static double FindTangent(bool invertY, double a, Vec2d v)
        {
        ...
        public static Vec2d ClothoDir(double s, bool invertY, double a)
        {
            double tg = ClothoTangent(s, invertY, a);
            return vecMath.NewRotate(tg);
        }

        public static Vec2d ClothoLeftNormal(double s, bool invertY, double a)
        {
            return vecMath.PerpLeft(ClothoDir(s, invertY, a));
        }

        public static Vec2d ClothoRightNormal(double s, bool invertY, double a)
        {
            return vecMath.PerpRight(ClothoDir(s, invertY, a));
        }
        ...
        public static Vec2d DClotho(double s, bool invertY, double a)
        {
            double x, y;
        ...
        public static Vec2d DClotho2(double s, bool invertY, double a)
        {
            double x, y;
        ...
        public static Vec2d DClotho3(double s, bool invertY, double a)
        {
            double x, y;
